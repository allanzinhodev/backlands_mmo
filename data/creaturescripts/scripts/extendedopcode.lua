...
---GetNinjaInfo/Skill----	  
	...
	return true
		...
		doPlayerAddSkill(cid, 3, 1, true)
		doPlayerSendTextMessage(cid,22,"You're now better at melee Weapons. ["..getPlayerSkill(cid, 3).."]")
	...
	return true
		...
		doPlayerAddSkill(cid, 4, 1, true)
		doPlayerSendTextMessage(cid,22,"You're now better at distance Weapons. ["..getPlayerSkill(cid, 4).."]")
	...
	if isInArray({2,7}, getPlayerVocation(cid)) then
