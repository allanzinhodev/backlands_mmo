...
void Connection::accept()
{
	...
	{
		++m_pendingRead;
		m_readTimer.expires_from_now(boost::posix_time::seconds((int)Connection::readTimeout));
...
void Connection::internalSend(OutputMessage_ptr msg)
{
	...
	{
		++m_pendingWrite;
		m_writeTimer.expires_from_now(boost::posix_time::seconds((int)Connection::writeTimeout));
