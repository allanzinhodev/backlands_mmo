...
Icons[8] = { tooltip = tr('You are under effect of food'), path = '/images/game/states/hungry', id = 'condition_drunk' }
...
Icons[1024] = { tooltip = tr('You are dizzy'), path = '/images/game/states/dazzled', id = 'condition_dazzled' }
...
function init()
  ...
  connect(g_game, {onGameStart, onGameEnd = offline })
...
function terminate()
  ...
  disconnect(g_game, { onGameStart, onGameEnd = offline })
...
function onFreeCapacityChange(player, freeCapacity)
  capLabel:setText(tr('Capacity') .. ': ' .. freeCapacity)
end
